  ...
  submitCourse: async (isDraft = true) => {
    ...
    try {
      ...
      const courseSettings = {
        ...
        percentageRequired: parseInt(settings?.percentageRequired || 80),
        ...
        hashTags: Array.isArray(settings?.hashTags) 
          ? settings.hashTags 
          : (typeof settings?.hashTags === 'string' 
      ...
      console.log('7. Final formatted data:', formattedData);
