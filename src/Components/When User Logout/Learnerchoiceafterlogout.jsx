      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {limitedCourses.map((course) => (   
             ...
             <div
  key={course.id}
  className="group bg-white border rounded p-3 hover:shadow-lg transition-shadow duration-300 h-40 cursor-pointer"
    ...
    <div className="flex-1">
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-gray-600 mb-2">{course.trainerName}</p>
        </div>
      ...
      <div className="flex items-center gap-2 mb-2">
        {course.courseSettings?.[0]?.settings && (
          <>
            <span className="text-blue-600 font-bold">₹{course.courseSettings[0].settings.price}</span>
