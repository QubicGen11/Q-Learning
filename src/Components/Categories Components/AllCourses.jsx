...
const AllCourses = () => {
  ...
  const assignTag = (course) => {
    ...
    console.log('Course averageRating:', averageRating, 'Course reviews:', reviews);

    if (averageRating >= 4.5 && reviews >= 500) {
      console.log('Assigned tag: Best Seller', course);
      return 'Best Seller';
    } else if (averageRating >= 4.0 && reviews >= 200) {
      console.log('Assigned tag: Trending', course);
      return 'Trending';
    } else if (averageRating >= 3.5) {
      console.log('Assigned tag: Hot', course);
      return 'Hot';
    }
    console.log('No tag assigned', course);
    return null; // No tag
  };

  const getTagColor = (tag) => {
    console.log(`Getting color for tag: ${tag}`);
    switch (tag) {
      case 'Best Seller':
        return 'bg-green-600';
      case 'Trending':
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {/* Price */}
                      <div className="absolute top-3 right-3 bg-white text-[#0056B3] px-3 py-1 rounded-full text-sm font-bold shadow-md">
