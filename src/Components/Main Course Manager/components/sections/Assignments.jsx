...
const Assignments = () => {
  ...
  const fetchCourses = async () => {
    try {
      ...
      const response = await axios.get(`${config.CURRENT_URL}/qlms/getUserCreatedCourse`, {
        headers: {
    ...
    try {
      ...
      if (response.data.message === "Question created and associated with assignment successfully") {
        ...
        const lessonResponse = await axios.get(
          `${config.CURRENT_URL}/qlms/getLessonQuestions/${currentAssignment.lessonId}`,
          {
            headers: {
              Authorization: `Bearer ${accessToken}`
            }
  ...
  const handleEditQuestion = async (questionId, lessonId, updatedQuestion) => {
    try {
      ...
      const response = await axios.put(
        `${config.CURRENT_URL}/qlms/updateQuestion/${questionId}`,
        payload,
        {
          headers: {
            'Authorization': `Bearer ${accessToken}`,
  ...
  const handleCreateAssignment = async (assignmentId) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${config.CURRENT_URL}/qlms/newAssignment`,
        payload,
        {
          headers: {
            'Authorization': `Bearer ${accessToken}`,
  ...
  const handleCreateQuestion = async (assignmentId) => {
    try {
      ...
      const getResponse = await axios.get(
        `${config.CURRENT_URL}/qlms/getLessonQuestions/${selectedLessonId}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`
          }
