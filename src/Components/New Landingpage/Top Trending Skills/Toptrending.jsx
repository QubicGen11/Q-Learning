                  ...
                  <div key={category} className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <div className="space-y-4">
                      {shuffledSubcategories.map((subCategory, index) => (
                        <div key={index}>
                              <Link 
      to={`/categories?category=${encodeURIComponent(category)}&subCategory=${encodeURIComponent(subCategory)}`} 
      className="text-[#0056B3] hover:underline flex items-center mb-1 text-sm"
    >
