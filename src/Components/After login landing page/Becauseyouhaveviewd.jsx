...
const Becauseyouhaveviewd = () => {
  ...
  const NextArrow = ({ onClick }) => (
    <div
      className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-gray-300 p-2 rounded-full cursor-pointer z-10 hover:bg-gray-400 hover:text-white"
      onClick={onClick}
    >
      →
    </div>
  ...
  const PrevArrow = ({ onClick }) => (
    <div
      className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-gray-300 p-2 rounded-full cursor-pointer z-10 hover:bg-gray-400 hover:text-white"
      onClick={onClick}
    >
      ←
    </div>
  ...
  return (
    <div className="px-6 py-8">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-4">
          <p className="text-lg font-bold">Because you viewed</p>
        </div>
